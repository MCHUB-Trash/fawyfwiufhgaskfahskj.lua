...
--[[
	...
	function uitab:Tab(text)
		...
		function main:Toggle(text,config,Imgidicon,callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(173, 121, 226)
...
[game.PlaceId] = {
    ...
    Welcome = function()
            ...
            " "
                ..
                	Gamename.. "!" .. " Rezy Hub"  .."\n Loadded Succesfully dev script by Cuarry.exe#4402"
            )
    end
}
}
...
function Tween(CFrame)
    ...
    coroutine.wrap(StopNoClip)(Distance, Speed)
...
spawn(function ()
    game:GetService("RunService").Heartbeat:Connect(function ()
        ...
        if Floor then
            Part.CFrame = CFrame.new( game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Y - 3.92, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
            else
            Part.CFrame = CFrame.new(100000, 0 , 10000)
        end
        end)
    end)
end)
	...
	game:GetService("RunService").Stepped:Connect(function()
		pcall(function()
			...
			if _G.Fastattack then
				if startATkmOb == true and (farm) then
...
spawn(function()
    game:GetService("RunService").Stepped:Connect(function()
        if _G.Fastattack == true or startATkmOb == true then
            game.Players.LocalPlayer.Character.Stun.Value = -(math.huge^math.huge)
            game.Players.LocalPlayer.Character.Humanoid.Sit = false
...
for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do  
 ...
 _G.SelectToolWeapon = _G.Save["SelectToolWeapon"] or ""
							...
							for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							   if v.Name == Ms and v:FindFirstChild("Humanoid") then
									 if v.Humanoid.Health > 0 then
										repeat wait()
										   ...
										   if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
												 if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,NameMon) then
													PosMonSKILL = v.HumanoidRootPart.CFrame
										...
										until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoFarmMBF == false or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(Ms) or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or raidiing or old_pos_count_time > 150
										old_pos_count_time = 0
										USEBF = false
									 end
								  end
...
spawn(function()
    pcall(function()
		game:GetService("RunService").RenderStepped:Connect(function()
            if USEBF and PosMonSKILL ~= nil then
                local args = {
                    [1] = PosMonSKILL.Position
                }
                game:GetService("Players").LocalPlayer.Character[game.Players.LocalPlayer.Data.DevilFruit.Value].RemoteEvent:FireServer(unpack(args))
							...
							for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							   if v.Name == Ms and v:FindFirstChild("Humanoid") then
									 if v.Humanoid.Health > 0 then
										...
										old_pos_count_time += 1
										until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoFarmGun == false or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(Ms) or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or raidiing or old_pos_count_time > 150
										old_pos_count_time = 0
										USEBF = false
									 end
								  end
											...
											if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
												if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,NameMon) then
													...
													if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 350 then
														...
														v.HumanoidRootPart.Transparency = 1.5
														if v.Humanoid:FindFirstChild("Animator") then
															v.Humanoid.Animator:Destroy()
														end
													end
...
spawn(function()
   pcall(function()
       game:GetService("RunService").Heartbeat:Connect(function()
           if _G.AutoFarm or _G.autoraid or getgenv().AutoNew or statetp1 or Autothird or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun or _G.KenHaki then
...
spawn(function()
 ...
 spawn(function()
	while game:GetService("RunService").Stepped:wait(10) do
		...
		if _G.NoClip or _G.AutoFarm or KillPlayer or getgenv().AutoNew or Autothird or Autothird or Factory or NextIsland or TweenIsland or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun then
			pcall(function()
...
spawn(function()
	game:GetService("RunService").Heartbeat:connect(function()
		pcall(function()
			CheckQuest()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.AutoFarmMBF or StartMagnet then
					if v.Name == Ms then
						if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 370 then
								v.HumanoidRootPart.CFrame = PosMonSKILL
								v.Humanoid.WalkSpeed = 0
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
								v.Humanoid.Sit = false
								if v.Humanoid:FindFirstChild("Animator") then v.Humanoid.Animator:Destroy() end
								if not v.HumanoidRootPart:FindFirstChild("BodyClip") then local Noclip = Instance.new("BodyVelocity") Noclip.Name = "BodyClip" Noclip.Parent = v.HumanoidRootPart Noclip.MaxForce = Vector3.new(100000,100000,100000) Noclip.Velocity = Vector3.new(0,0,0) end
								sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", 100000000000000)
								sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
							end
						end
					end
